...
class HomeAdapter(var activity: FragmentActivity?, var context: Context?, var data:List<Lesson>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, p2: ViewGroup?): View {
        ...
        if(convertView===null) {
            ...
            view =  layoutInflater.inflate(R.layout.item_schedule, null)
